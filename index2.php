...
<head>
    <title>Vets - Html Template for veterinary clinics</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
...
<body>
            ...
            <nav>
                <ul class="nav">
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="index-2.html">Caroufredsel</a>
                            </li>
                            <li>
                                <a href="index2.html">Nerveslider</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="single-vet.html">Single Vet</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="gallery-sidebar.html">Galleries - Sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="blog-sidebar.html">News - Sidebar</a>
                            </li>
                            <li>
                                <a href="single-post.html">Single News</a>
                            </li>
                            <li>
                                <a href="single-post-sidebar.html">Single News - Sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <div id="site-container">
        <div class="slider-container">
            ...
            <section id="home-slider">
                ...
                <div>
                    ...
                    <div class="ns_slideContent">
                        <div><span>Html Template for Vets</span>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="ns_slideContent">
                        <div><span>Responsive Design</span>
                        </div>
                    </div>
                </div>
                <div>
        ...
        <div class="nav-buttons">
            <span id="js-rotating">Opening Hours : Monday to Saturday - 8am to 9pm, Emergency : +1-800-654-3210</span>
            <div class="clear"></div>
        </div>
        <!-- MAIN CONTAINER -->
        <section class="page-block">
            ...
            <div class="grid">
                <div class="unit one-third">
                    <div class="icon-container">
                        <a href="#"><i class="flaticon-dog9"></i></a>
                    </div>
                    <div class="icon-text">
                        <h3>Pet Care</h3>
                ...
                <div class="unit one-third">
                    <div class="icon-container">
                        <a href="#"><i class="flaticon-heart258"></i></a>
                    </div>
                    <div class="icon-text">
                        <h3>Pet Hotel</h3>
                        <p>Voluptate illum dolore ita ipsum, quid deserunt singulis, labore admodum ita multos malis ea nam nam tamen fore amet. Vidisse quid incurreret ut ut possumus.</p>
                ...
                <div class="unit one-third">
                    <div class="icon-container">
                        <a href="#"><i class="flaticon-hospital21"></i></a>
                    </div>
                    <div class="icon-text">
                        <h3>Emergency</h3>
                        <p>Voluptate illum dolore ita ipsum, quid deserunt singulis, labore admodum ita multos malis ea nam nam tamen fore amet. Vidisse quid incurreret ut ut possumus.</p>
            ...
            <div class="grid">
                <div class="unit one-third">
                    <h3>Who we are</h3>
                    <div class="flex-img">
                        <img src="images/photos/small.jpg" alt="" />
                    </div>
                    <p>Voluptate illum dolore ita ipsum, quid deserunt singulis, labore admodum ita multos malis ea nam nam tamen fore amet. Vidisse quid incurre ut ut possumus transferrem E an concursionibus. Ex ex varias litteris quo labore te nescius et irure. Fugiat relinqueret ingeniis nisi pariatur, elit quo proident ubi summis aut varias ingeniis.</p>
                ...
                <div class="unit two-thirds">
                    ...
                    <div id="ourteam" class="owl-carousel">
                        ...
                        <figure class="our-team">
                            <a href="single-vet.html" class="ext-link">
                                <img src="images/photos/vet1.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div>
                                    <h5>Joe Doe</h5>
                                    <p>This text represents a brief introduction of veterinarian</p>
                                    <a href="single-vet.html" class="readmore-button">Read More...</a>
                                </div>
                            </figcaption>
                        </figure>
                        <!-- PERSON -->
                        <figure class="our-team">
                            <a href="single-vet.html" class="ext-link">
                                <img src="images/photos/vet4.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div>
                                    <h5>John Smith</h5>
                        ...
                        <figure class="our-team">
                            <a href="single-vet.html" class="ext-link">
                                <img src="images/photos/vet5.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div>
                                    <h5>Sarah Moore</h5>
                        ...
                        <figure class="our-team">
                            <a href="single-vet.html" class="ext-link">
                                <img src="images/photos/vet2.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div>
                                    <h5>Jane Yorke</h5>
                        ...
                        <figure class="our-team">
                            <a href="single-vet.html" class="ext-link">
                                <img src="images/photos/vet3.jpg" alt="" />
                            </a>
                            <figcaption>
                                <div>
                                    <h5>Maria Black</h5>
                    ...
                    <div id="verticalTab">
                        ...
                        <div class="resp-tabs-container">
                            ...
                            <div>
                                <!-- FLEX IMAGE -->
                                <div class="flex-img">
                                    <a href="single-service.html" class="ext-link">
                                ...
                                <a href="single-service.html" class="readmore-button">Read More...</a>
                            </div>
                            <!-- TAB 2 -->
                            <div>
                                <!-- FLEX IMAGE -->
                    ...
                    <div id="testimonials">
                        ...
                        <div class="testimonial">
                            ...
                            <div class="testimonial-image">
                                <img src="images/photos/test1.jpg" alt="" />
                        ...
                        <div class="testimonial">
                            ...
                            <div class="testimonial-image">
                                <img src="images/photos/test2.jpg" alt="" />
                        ...
                        <div class="testimonial">
                            ...
                            <div class="testimonial-image">
                                <img src="images/photos/test3.jpg" alt="" />
                        ...
                        <div class="testimonial">
                            ...
                            <div class="testimonial-image">
                                <img src="images/photos/test5.jpg" alt="" />
                ...
                <div class="unit whole">
                    ...
                    <div id="latestnews" class="owl-carousel">
                        ...
                        <figure class="latest-news">
                            <!-- POST IMAGE -->
                            <a href="single-post-sidebar.html" class="ext-link">
                                <img src="images/photos/post5.jpg" alt="" />
                            </a>
                            <!-- POST CONTENT -->
                            <figcaption>
                                <div>
                                    <h5><a href="single-post-sidebar.html">Sample Post</a></h5>
                                    <p class="latest-news-date">21 October 2014, by John Doe</p>
                                    <hr/>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat…</p>
                                    <a href="single-post-sidebar.html" class="readmore-button">Read More...</a>
                                </div>
                            </figcaption>
                        </figure>
                        <!-- POST -->
                        <figure class="latest-news">
                            <!-- POST IMAGE -->
                            <a href="single-post-sidebar.html" class="ext-link">
                                <img src="images/photos/post4.jpg" alt="" />
                            </a>
                            <!-- POST CONTENT -->
                            <figcaption>
                                <div>
                                    <h5><a href="single-post-sidebar.html">Sample Post</a></h5>
                                    <p class="latest-news-date">19 October 2014, by John Doe</p>
                                    <hr/>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat…</p>
                                    <a href="single-post-sidebar.html" class="readmore-button">Read More...</a>
                                </div>
                        ...
                        <figure class="latest-news">
                            <!-- POST IMAGE -->
                            <a href="single-post-sidebar.html" class="ext-link">
                                <img src="images/photos/post2.jpg" alt="" />
                            </a>
                            <!-- POST CONTENT -->
                            <figcaption>
                                <div>
                                    <h5><a href="single-post-sidebar.html">Sample Post</a></h5>
                                    <p class="latest-news-date">17 October 2014, by John Doe</p>
                                    <hr/>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat…</p>
                                    <a href="single-post-sidebar.html" class="readmore-button">Read More...</a>
                                </div>
                        ...
                        <figure class="latest-news">
                            <!-- POST IMAGE -->
                            <a href="single-post-sidebar.html" class="ext-link">
                                <img src="images/photos/post3.jpg" alt="" />
                            </a>
                            <!-- POST CONTENT -->
                            <figcaption>
                                <div>
                                    <h5><a href="single-post-sidebar.html">Sample Post</a></h5>
                                    <p class="latest-news-date">15 October 2014, by John Doe</p>
                                    <hr/>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat…</p>
                                    <a href="single-post-sidebar.html" class="readmore-button">Read More...</a>
                                </div>
                        ...
                        <figure class="latest-news">
                            <!-- POST IMAGE -->
                            <a href="single-post-sidebar.html" class="ext-link">
                                <img src="images/photos/post.jpg" alt="" />
                            </a>
                            <!-- POST CONTENT -->
                            <figcaption>
                                <div>
                                    <h5><a href="single-post-sidebar.html">Sample Post</a></h5>
                                    <p class="latest-news-date">14 October 2014, by John Doe</p>
                                    <hr/>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat…</p>
                                    <a href="single-post-sidebar.html" class="readmore-button">Read More...</a>
                                </div>
    ...
    <footer id="footer">
        <div id="footer-widgets" class="grid">
            ...
            <div class="footer-widget unit one-third">
                <h5>Get In Touch</h5>
                <p><strong>Address:</strong> Lorem ipsum street 1283 New York/United States
                </p>
                <p><strong>Phone:</strong> 317-456-2564
                </p>
                <p><strong>E-mail:</strong> youremail@yoursite.com
                </p>
            </div>
            <!-- WIDGET 2 -->
            <div class="footer-widget unit one-third">
                ...
                <ul class="footer-list">
                    <li>
                        <a href="single-post.html">Lorem Ipsum dolor eget mentitum</a>
                    </li>
                    <li>
                        <a href="single-post.html">Nibh mauris lucem id possumus</a>
                    </li>
                    <li>
                        <a href="single-post.html">Donec in lorem mauris senserit</a>
                    </li>
                    <li>
                        <a href="single-post.html">Auctor mauris urna loe cupidat</a>
                    </li>
                </ul>
            </div>
            <!-- WIDGET 3 -->
    ...
    <script type="text/javascript" src="js/jquery.wordrotator.js"></script>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            "use strict";
            jQuery('.slider-container').backstretch("images/photos/blur.jpg");
        });
    </script>
    <!-- SLIDER -->
    <script type="text/javascript">
